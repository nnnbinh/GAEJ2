...
<body>
	<div class="container mt-2">
		<span class="nav"><a href="/index.html">Search</a></span>
		<p />
		...
		<br>
		<a
			href="telesales?action=opportunityCreate&accountId=<%=account.getId()%>">Create
			a new Opportunity</a>
		<p />
		...
		%>
		<p />
		<span class="heading">Opportunities for <%=account.getName()%></span><br>
		<p />
		...
		%>
		<p />
		<span class="heading">No Opportunities found for <%=account.getName()%></span>
		<%
		}
		%>
	</div>
